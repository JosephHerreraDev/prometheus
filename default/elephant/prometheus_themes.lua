--
-- Dynamic Prometheus Theme Menu for Elephant/Walker
--
Name = "prometheusthemes"
NamePretty = "Prometheus Themes"
...
function GetEntries()
  local entries = {}
  local user_theme_dir = os.getenv("HOME") .. "/.config/prometheus/themes"
  local prometheus_path = os.getenv("PROMETHEUS_PATH") or ""
  local default_theme_dir = prometheus_path .. "/themes"
      ...
      if theme_name and not seen_themes[theme_name] then
        ...
        if preview_path and preview_path ~= "" then
          ...
          table.insert(entries, {
            ...
            PreviewType = "file",
            Actions = {
              activate = "prometheus-theme-set " .. theme_name,
            },
          })
        end
      end
